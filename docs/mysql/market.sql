...
CREATE TABLE `raffle_activity` (
  ...
  `begin_date_time` datetime NOT NULL COMMENT '活动开始时间',
  `end_date_time` datetime NOT NULL COMMENT '活动结束时间',
  `strategy_id` int NOT NULL COMMENT '策略id',
  `state` varchar(128) NOT NULL COMMENT '活动状态',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- ----------------------------
INSERT INTO `raffle_activity` VALUES ('1', '100301', '测试活动', '测试活动', '2024-03-09 10:15:10', '2034-03-09 10:15:10', '100006', 'open', '2024-03-09 10:15:10', '2024-03-09 10:15:17');
INSERT INTO `raffle_activity` VALUES ('2', '200402', '正式活动', '正式活动', '2025-07-01 17:35:03', '2025-10-01 17:35:16', '100001', 'open', '2025-07-03 17:35:03', '2025-07-03 17:35:03');
...
CREATE TABLE `raffle_activity_count` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `activity_count_id` int NOT NULL COMMENT '活动次数编号',
...
-- ----------------------------
INSERT INTO `raffle_activity_count` VALUES ('1', '11101', '1', '1', '1', '2024-03-09 10:15:42', '2024-03-09 10:15:42');
INSERT INTO `raffle_activity_count` VALUES ('2', '22202', '2', '2', '2', '2025-07-01 17:35:03', '2025-07-01 17:35:03');
...
CREATE TABLE `raffle_activity_sku` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `sku` int NOT NULL COMMENT '商品sku',
  `activity_id` int NOT NULL COMMENT '活动id',
  `activity_count_id` int NOT NULL COMMENT '活动个人参与次数id',
  `stock_count` int NOT NULL COMMENT '商品库存',
  `stock_count_surplus` int NOT NULL COMMENT '剩余库存',
  `create_time` date NOT NULL COMMENT '创建时间',
  `update_time` date NOT NULL COMMENT '剩余时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- ----------------------------
INSERT INTO `raffle_activity_sku` VALUES ('1', '9011', '100301', '11101', '20', '11', '2025-04-20', '2025-07-04');
INSERT INTO `raffle_activity_sku` VALUES ('2', '9022', '200402', '22202', '20', '16', '2025-07-01', '2025-07-04');
...
INSERT INTO `rule_tree` VALUES ('4', 'tree_lock_6', '规则树', '规则树', 'rule_lock', '2025-07-03 20:11:16', '2025-07-03 20:11:18');
...
INSERT INTO `rule_tree_node` VALUES ('6', 'tree_lock_2', 'rule_lock', '限定用户已完成N次抽奖后解锁', '2', '2025-03-13 17:28:13', '2025-03-13 17:28:13');
...
INSERT INTO `rule_tree_node` VALUES ('9', 'tree_lock_6', 'rule_lock', '限定用户已完成N次抽奖后解锁', '6', '2025-07-03 20:12:04', '2025-07-03 20:12:08');
INSERT INTO `rule_tree_node` VALUES ('10', 'tree_lock_6', 'rule_luck_award', '兜底奖品随机积分', '101:100', '2025-07-03 20:13:09', '2025-07-03 20:13:11');
INSERT INTO `rule_tree_node` VALUES ('11', 'tree_lock_6', 'rule_stock', '库存扣减规则', null, '2025-07-03 20:13:38', '2025-07-03 20:13:40');
...
INSERT INTO `rule_tree_node_line` VALUES ('8', 'tree_lock_6', 'rule_lock', 'rule_stock', 'EQUAL', 'ALLOW', '2025-07-03 20:14:25', '2025-07-03 20:14:28');
INSERT INTO `rule_tree_node_line` VALUES ('9', 'tree_lock_6', 'rule_lock', 'rule_luck_award', 'EQUAL', 'TAKE_OVER', '2025-07-03 20:14:28', '2025-07-03 20:14:28');
INSERT INTO `rule_tree_node_line` VALUES ('10', 'tree_lock_6', 'rule_stock', 'rule_luck_award', 'EQUAL', 'ALLOW', '2025-07-03 20:14:28', '2025-07-03 20:14:28');
...
-- ----------------------------
INSERT INTO `strategy_award` VALUES ('1', '100001', '101', '随机积分', null, '80000', '79959', '0.3000', 'tree_luck_award', '1', '2025-03-13 18:04:22', '2025-03-13 18:04:22');
INSERT INTO `strategy_award` VALUES ('2', '100001', '102', '5次使用', null, '10000', '9970', '0.2000', 'tree_luck_award', '2', '2025-03-13 18:04:22', '2025-03-13 18:04:22');
INSERT INTO `strategy_award` VALUES ('3', '100001', '103', '10次使用', null, '5000', '4979', '0.2000', 'tree_luck_award', '3', '2025-03-13 18:04:22', '2025-03-13 18:04:22');
INSERT INTO `strategy_award` VALUES ('4', '100001', '104', '20次使用', null, '4000', '3990', '0.1000', 'tree_luck_award', '4', '2025-03-13 18:04:22', '2025-03-13 18:04:22');
INSERT INTO `strategy_award` VALUES ('5', '100001', '105', '增加GPT-01模型', null, '2000', '1991', '0.1000', 'tree_luck_award', '5', '2025-03-13 18:04:22', '2025-03-13 18:04:22');
INSERT INTO `strategy_award` VALUES ('6', '100001', '106', '增加GPT-03-mini模型', null, '1000', '988', '0.0500', 'tree_luck_award', '6', '2025-03-13 18:04:22', '2025-03-13 18:04:22');
INSERT INTO `strategy_award` VALUES ('7', '100001', '107', '增加DALL-E-2模型', '抽奖1次后解锁', '1000', '995', '0.0400', 'tree_lock_1', '7', '2025-03-13 18:04:22', '2025-03-13 18:04:22');
INSERT INTO `strategy_award` VALUES ('8', '100001', '108', '增加100次使用次数', '抽奖2次后解锁', '500', '500', '0.0099', 'tree_lock_2', '8', '2025-03-13 18:04:22', '2025-03-13 18:04:22');
INSERT INTO `strategy_award` VALUES ('9', '100001', '109', '获得所有模型', '抽奖6次后解锁', '300', '300', '0.0001', 'tree_lock_6', '9', '2025-03-13 18:04:22', '2025-03-13 18:04:22');
...
INSERT INTO `strategy_award` VALUES ('13', '100006', '101', '随机积分', null, '100', '79', '0.0200', 'tree_luck_award', '1', '2025-03-23 20:08:22', '2025-03-23 20:08:24');
INSERT INTO `strategy_award` VALUES ('14', '100006', '102', '7等奖', null, '100', '73', '0.0300', 'tree_luck_award', '2', '2025-03-23 20:09:04', '2025-03-23 20:09:07');
INSERT INTO `strategy_award` VALUES ('15', '100006', '103', '6等奖', null, '100', '76', '0.0300', 'tree_luck_award', '3', '2025-03-23 20:10:15', '2025-03-23 20:10:18');
INSERT INTO `strategy_award` VALUES ('16', '100006', '104', '5等奖', null, '100', '63', '0.0300', 'tree_luck_award', '4', '2025-03-23 20:10:52', '2025-03-23 20:10:54');
INSERT INTO `strategy_award` VALUES ('17', '100006', '105', '4等奖', null, '100', '61', '0.0300', 'tree_luck_award', '5', '2025-03-23 20:11:23', '2025-03-23 20:11:26');
...
INSERT INTO `strategy_award` VALUES ('19', '100006', '107', '2等奖', '抽奖1次后解锁', '100', '92', '0.0300', 'tree_lock_1', '7', '2025-03-23 20:12:35', '2025-03-23 20:12:33');
INSERT INTO `strategy_award` VALUES ('20', '100006', '108', '1等奖', '抽奖2次后解锁', '100', '100', '0.0300', 'tree_lock_2', '8', '2025-03-23 20:13:11', '2025-03-23 20:13:13');
